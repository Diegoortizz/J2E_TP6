...
public class BankingTest {
    ...
    public void pasassezArgentTransfer() throws Exception {
        myDAO.bankTransferTransaction(1, 1, 150.5f);
    }

    @Test
    public void Existepas1() {
        try {
            myDAO.bankTransferTransaction(0, 2, 10.5f);
        } catch (Exception ex) {
            String s = ex.getLocalizedMessage();
            assertEquals(s, "Le client 2 n'existe pas");
        }
    }
